                            ...
                            <div id="2" className="md-4">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p>&emsp;&emsp;多人 VR 應用透過即時更新參與者們的狀態，實現高沈浸度的互動體驗。在無線傳輸延遲高的情況下，計算並更新大量的資訊將會因無線傳輸的高延遲而無法滿足使用者的高沈浸式體驗。
                                            透過社群網路的資訊，我們可以知道在 VR 環境中彼此的重要程度。</p>
                                        <p>&emsp;&emsp;因此在網路資源有限的情況下，對於一個使用者，邊緣伺服器 (Edge Server) 可以根據社群網路的資訊與 VR 環境優先選擇傳輸至重要性高的參與者們，降低資訊傳輸量與時間，以滿足使用者體驗。</p>
                                    </li>
                                    <li>
                                        <h5 className='yahei'>360° 影片的防暈眩與適應性串流</h5>
                                        <span>在無線頻寬的限制下，利用使用者行為預測、影片品質的變化與電腦視覺的技術處理讓使用者觀看360度影片時較不容易產生頭暈、想吐等不適症狀，同時維持良好的使用者體驗。</span>
                                    </li>                                    
                                </ul>
                                <br/>
                                <p>相關的合作計畫如下</p>
